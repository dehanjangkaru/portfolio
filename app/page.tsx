...
<<<<<<< HEAD

  {
    ...
    description:
      "A multi-page university web experience with comprehensive campus profiles, faculty directories, news management, an admissions flow, and structured academic information.",
    technologies: ["PHP", "Tailwind CSS", "JavaScript", "MySQL", "Laravel"],
